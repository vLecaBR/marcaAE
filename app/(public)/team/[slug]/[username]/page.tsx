    ...
    <div className="flex min-h-screen flex-col items-center px-4 py-16 sm:px-6">
      <div className="w-full max-w-3xl">
        ...
        <div className="mb-10 text-center">
          <div className="mx-auto mb-5 h-20 w-20 overflow-hidden rounded-full ring-4 ring-zinc-950 bg-zinc-800">
          ...
          <p className="mt-2 inline-block rounded-full bg-zinc-900 px-3 py-1 text-xs font-medium text-zinc-400">
            Membro da equipe <span className="text-white">{teamMember.team.name}</span>
          </p>
        </div>
        ...
        {eventTypes.length > 0 ? (
          ...
          <div className="rounded-2xl border border-zinc-800 border-dashed bg-zinc-900/20 py-16 text-center">
            ...
            <p className="mt-1 text-sm text-zinc-500">{teamMember.user.name} ainda não configurou nenhum tipo de evento coletivo.</p>
          </div>
        )}
