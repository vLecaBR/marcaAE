...
public interface IBillingService
{
    ...
    /// <summary>Status rico da assinatura (precisa ser membro). Null se equipe inexistente/sem acesso.</summary>
    Task<BillingStatusDto?> GetStatusAsync(string teamId, string userId, CancellationToken cancellationToken = default);
